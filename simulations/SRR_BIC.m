function [ opt_cri, type ] = SRR_BIC( path_ctrl )
%SF_BIC_fractional - for a given solution path compute the values of
%BIC. path_ctrl is the output_ctrl from
%SRR_solution_path
%
...
opt_cri = logterm + log(numel(Y)) * penDF;
