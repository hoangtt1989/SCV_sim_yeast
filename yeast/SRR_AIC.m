function [ opt_cri, type ] = SRR_AIC( path_ctrl )
%SF_AIC_fractional - for a given solution path compute the values of
%AIC. path_ctrl is the output_ctrl from
%SRR_solution_path
%
