function [opt_ctrl, type] ...
    = SRR_CV(input_ctrl, CVSplit_ctrl, conv_ctrl, type_ctrl)
...
%     tmpInds = 1:size(oriY, 1);
    ...
    trn_output_ctrl = SRR_solution_path(trn_ctrl, conv_ctrl, type_ctrl);
    num_params = trn_output_ctrl.num_Bs;
